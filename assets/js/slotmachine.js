                ...
                set: function set(FX_SPEED) {
                    ...
                    raf(function() {
                        ...
                        if (FX_SPEED === FX_STOP) {
                            ...
                            document.getElementById("wheel1").className = "spin-wheel ball";
                            document.getElementById("wheel2").className = "spin-wheel ball";
                            document.getElementById("wheel3").className = "spin-wheel ball";
                        } else {
            ...
            _createClass(Timer, [{
                ...
                value: function _start() {
                    ...
                    this.timer = setTimeout(function() {
                        document.getElementById("wheel1").className = "spin-fast ball";
                        document.getElementById("wheel2").className = "spin-fast ball";
